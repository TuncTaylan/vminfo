...
public class VminfoApp {

    private static final Logger log = LoggerFactory.getLogger(VminfoApp.class);

    private final Environment env;

    public VminfoApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(VminfoApp.class);
